...
export function testPhones(): PhoneOverview[] {
  return [
    { age: 3, id: '', imageUrl: '', name: 'Phone 0', snippet: '' },
    { age: 2, id: '', imageUrl: '', name: 'Phone 1', snippet: '' },
    { age: 1, id: '', imageUrl: '', name: 'Phone 2', snippet: '' }
  ];
}
